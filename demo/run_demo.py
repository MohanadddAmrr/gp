    ...
    def _chunked_frame_generator():
        ...
        for chunk_idx in range(num_chunks):
            ...
            for local_idx in range(end_frame - start_frame):
                ...
                # --- START OF ADDED VIDEO DISPLAY LOGIC ---
                # Draw detections on the frame for live feedback
                annotated_frame = res.plot() 
                cv2.imshow("TactiVision Pro - Live Detection", annotated_frame)
                ...
                if cv2.waitKey(1) & 0xFF == ord('q'):
                    ...
                    sys.exit()
                # --- END OF ADDED VIDEO DISPLAY LOGIC ---
